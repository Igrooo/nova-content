...
/*
    ...
    $('.disp').click(function() {
                                 ...
                                 $('#explorer-body').removeClass('list grid col') });

    $('#list').click(function() {
                                 $( this ).addClass('active');
                                 $('#explorer-body').addClass('list');
                                 $('#explorer-item, #home').attr('href','?disp=list&dir');
                                 replacehref($('#back'), 'list');
                                 replacehref($('#path a'), 'list');
                                 replacehref($('#explorer-body .folder a'), 'list');
                                 return false;
    });

    $('#grid').click(function() {
                                 $( this ).addClass('active');
                                 $('#explorer-body').addClass('grid');
                                 $('#explorer-item, #home').attr('href','?disp=grid&dir');
                                 replacehref($('#back'), 'grid');
                                 replacehref($('#path a'), 'grid');
                                 replacehref($('#explorer-body .folder a'), 'grid');
                                 return false;
                                });

    $('#col').click(function()  {
                                 $( this ).addClass('active');
                                 $('#explorer-body').addClass('col');
                                 $('#explorer-item, #home').attr('href','?disp=col&dir');
                                 replacehref($('#back'), 'col');
                                 replacehref($('#path a'), 'col');
                                 replacehref($('#explorer-body .folder a'), 'col');
                                 return false;
                                });*/
});